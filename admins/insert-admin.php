...
if (isset($_POST['uname']) && isset($_POST['password'])
    && isset($_POST['admin_name']) && isset($_POST['re_password'])) {
	...
	$user_data = 'uname='. $uname. '&admin_name='. $admin_name;
	if (empty($uname)) {
		...
		if (mysqli_num_rows($result) > 0) {
           ...
           $sql2 = "INSERT INTO users(user_name, password, admin_name) VALUES('$uname', '$pass', '$admin_name')";
